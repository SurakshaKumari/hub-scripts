...
const { getScripts, getTrendingScripts, getFeaturedScripts, getScriptById, createScript, updateScript, deleteScript, getUserScripts } = require('../controllers/scriptController');
